{
  ...
  outputs = inputs:
    inputs.flake-parts.lib.mkFlake { inherit inputs; } {
      imports = [
        ./zomes/integrity/fixie/zome.nix
        ./zomes/coordinator/fixie/zome.nix
        ...
        packages.scaffold = pkgs.symlinkJoin {
          ...
          postBuild = ''
            wrapProgram $out/bin/scaffold-remote-zome \
              --add-flags "fixie-zome \
                --integrity-zome-name fixie_integrity \
                --coordinator-zome-name fixie \
                --remote-zome-git-url github:darksoil-studio/fixie-zome \
                --remote-npm-package-name @darksoil-studio/fixie-zome \
                --remote-zome-git-branch main-0.4 \
                --context-element fixie-context \
                --context-element-import @darksoil-studio/fixie-zome/dist/elements/fixie-context.js" 
          '';
        };
      };
    };
